        ...
        <div className="p-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 flex justify-center gap-4 text-slate-400">
              <a href="https://instagram.com/homeofelectronics" target="_blank" rel="noopener" className="hover:text-pink-600 transition">
                <FaInstagram size={20} />
              </a>
              <a href="https://tiktok.com/@homeofelectronics" target="_blank" rel="noopener" className="hover:text-black transition">
                <FaTiktok size={20} />
              </a>
            </div>
          </div>
