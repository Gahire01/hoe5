      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white p-10 rounded-[3rem] shadow-xl space-y-8">
            <div className="flex items-center gap-4"><div className="w-16 h-16 bg-cyan-500 rounded-2xl flex items-center justify-center text-slate-900"><MapPin size={32} /></div><div><h3 className="text-2xl font-black">Our Flagship Store</h3><p className="text-slate-500">{CONTACT_INFO.location}</p></div></div>
            <div className="space-y-4"><div className="flex items-center gap-3 text-slate-600"><Phone size={20} className="text-cyan-500" /><span>{CONTACT_INFO.phone}</span></div><div className="flex items-center gap-3 text-slate-600"><Mail size={20} className="text-cyan-500" /><span>{CONTACT_INFO.email}</span></div></div>
